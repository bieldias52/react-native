...
import Button from './scr/componentes/Button';

import Display from './scr/componentes/Display';
  ...
  export default class App extends Component{
        ...
        digito = n => {
            ...
            if (n !== '.') {
                ...
                const values = [...this.state.values]      // estou criando um clone do array values  // mudando de ',' para '.'
